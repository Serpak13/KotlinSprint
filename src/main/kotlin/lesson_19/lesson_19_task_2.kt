...
fun main() {
    ...
    val product1: ProductDescription = ProductDescription("Свитшот", 1564, Category.CLOTHES)
    val product2: ProductDescription = ProductDescription("Степлер", 5896, Category.CHANCELLERY)
    val product3: ProductDescription = ProductDescription("Мочалка", 8526, Category.OTHER)
